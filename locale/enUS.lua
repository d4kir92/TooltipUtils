...
TooltipUtils:AddTrans("enUS", "LID_UNITTOOLTIP", "Unit Tooltip")
TooltipUtils:AddTrans("enUS", "LID_ITEMTOOLTIP", "Item Tooltip")
TooltipUtils:AddTrans("enUS", "LID_CROWDCONTROL", "Crowd Control")
...
TooltipUtils:AddTrans("enUS", "LID_POLYMORPHABLE", "Polymorphable")
TooltipUtils:AddTrans("enUS", "LID_BANISHABLE", "Banishable")
TooltipUtils:AddTrans("enUS", "LID_SHOWBONUSIDS", "Show BonusIDs")
TooltipUtils:AddTrans("enUS", "LID_SHOWITEMLEVEL", "Show Itemlevel")
