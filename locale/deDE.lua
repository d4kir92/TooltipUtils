...
TooltipUtils:AddTrans("deDE", "LID_UNITTOOLTIP", "Einheiten-Tooltip")
TooltipUtils:AddTrans("deDE", "LID_ITEMTOOLTIP", "Gegenstands-Tooltip")
TooltipUtils:AddTrans("deDE", "LID_CROWDCONTROL", "Massenkontrolle")
...
TooltipUtils:AddTrans("deDE", "LID_POLYMORPHABLE", "Verwandelbar")
TooltipUtils:AddTrans("deDE", "LID_BANISHABLE", "Verbannbar")
TooltipUtils:AddTrans("deDE", "LID_SHOWBONUSIDS", "BonusIDs anzeigen")
TooltipUtils:AddTrans("deDE", "LID_SHOWITEMLEVEL", "Gegenstandsstufe anzeigen")
